...
class t_DlgMessage: public QDialog
{
   ...
   public:
      t_DlgMessage ();
      t_DlgMessage (const QString &Title, QString Message, bool Monospaced=false, QWidget *pParent=NULL, Qt::WindowFlags Flags=0);
     ~t_DlgMessage ();

      void AdjustGeometry (void);

      static APIRET Show (const QString &Title, const QString &Message, bool Monospaced=false, QWidget *pParent=NULL, Qt::WindowFlags Flags=0);

...
class t_ThreadScanWorkerUdevLocal
{
   public:
      ...
      {
         pFnLibUdev_udev_new                           = NULL;
         pFnLibUdev_udev_unref                         = NULL;
         pFnLibUdev_udev_device_unref                  = NULL;
         pFnLibUdev_udev_enumerate_new                 = NULL;
         pFnLibUdev_udev_enumerate_unref               = NULL;
         pFnLibUdev_udev_enumerate_add_match_subsystem = NULL;
         pFnLibUdev_udev_enumerate_add_match_property  = NULL;
         pFnLibUdev_udev_enumerate_scan_devices        = NULL;
         pFnLibUdev_udev_enumerate_get_list_entry      = NULL;
         pFnLibUdev_udev_list_entry_get_name           = NULL;
         pFnLibUdev_udev_device_new_from_syspath       = NULL;
         pFnLibUdev_udev_device_get_property_value     = NULL;
         pFnLibUdev_udev_list_entry_get_next           = NULL;
      }
...
void t_ThreadScanWorkerUdev::SlotRescan (void)
{
   ...
   struct udev_enumerate  *pUdevEnum   = NULL;
   struct udev_device     *pUdevDevice = NULL;
...
APIRET t_ThreadScan::Start (t_ThreadScanWorker **ppWorker)
{
   ...
   for (Tries=1;;Tries++)  // Try all scan methods if necessary
   {
          ...
          (Wait      >=  THREADSCAN_WAIT_MAX))
      {
         ...
         {
            t_MessageBox::critical (NULL, tr ("Cannot scan devices", "Dialog title"),
...
{
   t_ThreadScanWorker *pWorker   = NULL;
